...
func TestRodPageClickForceHardCeiling(t *testing.T) {
...
func TestRodPageClickForcePassesThroughDriverResult(t *testing.T) {
	wantErr := errors.New("driver error")
	p := &rodPage{clickFn: func(string, time.Duration, time.Duration) error { return wantErr }}
